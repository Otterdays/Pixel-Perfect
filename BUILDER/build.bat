...
cd ..
python -m PyInstaller --name="PixelPerfect" --onefile --windowed --optimize=2 --icon="%ICON_PATH%" --add-data="%LOGO_PATH%;." --exclude-module=pygame --exclude-module=scipy --exclude-module=tkinter.test --exclude-module=unittest --exclude-module=test --exclude-module=xml.etree --exclude-module=xml.dom --exclude-module=doctest --exclude-module=pdb --exclude-module=email --exclude-module=http --exclude-module=urllib --exclude-module=xmlrpc --exclude-module=pydoc --exclude-module=bz2 --exclude-module=lzma --exclude-module=_ssl --exclude-module=ssl --exclude-module=charset_normalizer --exclude-module=pycparser --hidden-import=src.core.canvas --hidden-import=src.core.canvas_renderer --hidden-import=src.core.color_palette --hidden-import=src.core.custom_colors --hidden-import=src.core.event_dispatcher --hidden-import=src.core.layer_manager --hidden-import=src.core.project --hidden-import=src.core.undo_manager --hidden-import=src.core.saved_colors --hidden-import=src.core.window_state_manager --hidden-import=src.tools.base_tool --hidden-import=src.tools.brush --hidden-import=src.tools.eraser --hidden-import=src.tools.eyedropper --hidden-import=src.tools.fill --hidden-import=src.tools.selection --hidden-import=src.tools.shapes --hidden-import=src.tools.pan --hidden-import=src.tools.texture --hidden-import=src.ui.main_window --hidden-import=src.ui.dialog_manager --hidden-import=src.ui.file_operations_manager --hidden-import=src.ui.selection_manager --hidden-import=src.ui.tool_size_manager --hidden-import=src.ui.canvas_zoom_manager --hidden-import=src.ui.grid_control_manager --hidden-import=src.ui.background_control_manager --hidden-import=src.ui.notes_panel --hidden-import=src.ui.theme_dialog_manager --hidden-import=src.ui.ui_builder --hidden-import=src.ui.layer_panel --hidden-import=src.ui.timeline_panel --hidden-import=src.ui.color_wheel --hidden-import=src.ui.theme_manager --hidden-import=src.ui.tooltip --hidden-import=src.ui.import_png_dialog --hidden-import=src.ui.canvas_operations_manager --hidden-import=src.ui.layer_animation_manager --hidden-import=src.ui.color_view_manager --hidden-import=src.ui.loading_screen --hidden-import=src.ui.palette_views --hidden-import=src.ui.palette_views.grid_view --hidden-import=src.ui.palette_views.primary_view --hidden-import=src.ui.palette_views.constants_view --hidden-import=src.ui.palette_views.saved_view --hidden-import=src.utils.export --hidden-import=src.utils.import_png --hidden-import=src.utils.presets --hidden-import=src.utils.file_association --hidden-import=src.animation.timeline --distpath="BUILDER\dist" --workpath="BUILDER\build" --specpath="BUILDER" main.py
if errorlevel 1 (
