...
- **PNG Import**: Convert 16x16/32x32/64x64 PNGs back to editable .pixpf projects
- Validates dimensions automatically
- Preserves exact pixel data
- Single-layer import with metadata
- Option to open immediately after import
